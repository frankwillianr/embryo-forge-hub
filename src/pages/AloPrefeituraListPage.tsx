...
const AloPrefeituraListPage = () => {
  ...
  // Scroll autom·tico atÈ a publicaÁ„o quando h· hash na URL
  useEffect(() => {
    if (isLoading) return;
      ...
      <div className="relative h-52 overflow-hidden border-b border-border">
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <div className="rounded-2xl border border-white/20 bg-white/12 px-4 py-3 backdrop-blur-md shadow-lg">
            ...
            <p className="mt-1 text-xs text-white/80">Relatos da cidade para acompanhar, apoiar e cobrar solu√ß√µes.</p>
          </div>
        </div>
      </div>
